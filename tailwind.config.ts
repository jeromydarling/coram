...
/**
 * The shadcn token wiring is carried over from the previous project. The
 ...
 * marketing site to justify it, not before.
 */
export default {
  darkMode: ['class'],
  content: ['./index.html', './src/app/**/*.{ts,tsx}', './src/worker/routes/**/*.tsx'],
  prefix: '',
  theme: {
    container: {
      center: true,
